...
<nav class="bg-black p-6 shadow-md">
  <div class="container mx-auto flex justify-between items-center">
      ...
      <div class="hidden md:flex space-x-8">
          <a href="#" class="nav-link font-bold text-xl text-yellow-300 hover:text-green-400">Home</a>
          <a href="#" class="nav-link font-bold text-xl text-yellow-300 hover:text-green-400">About</a>
          <a href="#" class="nav-link font-bold text-xl text-yellow-300 hover:text-green-400">Our Product</a>
          <a href="#" class="nav-link font-bold text-xl text-yellow-300 hover:text-green-400">Contact Us</a>
      </div>
...
<div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
  <a href="#" class="block text-yellow-300 hover:text-green-400 py-2 transition duration-300">Home</a>
  <a href="#" class="block text-yellow-300 hover:text-green-400 py-2 transition duration-300">About</a>
  <a href="#" class="block text-yellow-300 hover:text-green-400 py-2 transition duration-300">Our Product</a>
  <a href="#" class="block text-yellow-300 hover:text-green-400 py-2 transition duration-300">Contact Us</a>
</div>
</div>
